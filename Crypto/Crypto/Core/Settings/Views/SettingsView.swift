...
//  Crypto
//
//  Created by Jethro Liu on 2025/04/22.
//
...
struct SettingsView: View {
    ...
    let coffeeURL = URL(string: "https://github.com/AlureLove")!
    let coingeckoURL = URL(string: "https://www.coingecko.com")!
    let personURL = URL(string: "https://alurelove.github.io/personal_page/")!
...
extension SettingsView {
    ...
    private var developerSection: some View {
        Section {
            ...
            .padding(.vertical)
            Link("Visit Website 🥳", destination: personURL)
        } header: {
            Text("Developer")
        }
    }
